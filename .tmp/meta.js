import ColorfulButtonMeta from 'D:\\workspace\\lowcode-sunyue\\lowcode\\colorful-button\\meta'
import ColorfulInputMeta from 'D:\\workspace\\lowcode-sunyue\\lowcode\\colorful-input\\meta'
...
function fillRealVersion(meta, packageName = 'my-material', version = '0.1.0', basicLibraryVersion={"@alifd/next":"1.25.23","@alifd/meet":"2.6.3","antd":"4.17.3"}) {
  if (!meta || !version) {
    return meta;
  }
  const { npm } = meta;
...
if (!execCompile) {
  window.MyMaterialMeta = { components, componentList };
}